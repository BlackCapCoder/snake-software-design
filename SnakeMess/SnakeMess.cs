...
1)%2);A=k!=27&!s.Contains(n);Threading.Thread.Sleep(80);if(b^=k==32)goto C;v=14;G(new[]{q,n,s.First()},"0@ ");s=s.Skip(n
!=p?1:0).Append(n);if(n==p)goto S;}void G(P[]j,string x){ForegroundColor=(ConsoleColor)v;for(v=0;v<x.Length;){
