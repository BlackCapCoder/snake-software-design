...
k,w=WindowWidth,h=WindowHeight;var r=new Random();P p=new P();var s=new P[4].Select(_=>new P{X=10,Y=10}).ToList();var t=
new Diagnostics.Stopwatch();t.Start();Clear();CursorVisible=!A;Title="snk";S();while(A){for(v=0,k=KeyAvailable?(int)
